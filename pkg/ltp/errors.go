...
var (
	...
	// value RFC 5326 §3.1 defines.
	ErrInvalidVersion = errors.New("invalid LTP version: only version 0 is defined")

	// ErrUndefinedSegmentType indicates one of the type codes RFC 5326 §3.1.2
	...
	// extensions, which the 4-bit counts of §3.1.4 cannot describe.
	...
	// zero where §3.2.1 and §3.2.2 forbid it.
	...
	// red-part data above a green-part offset, which §3.2.4 calls MISCOLORED.
