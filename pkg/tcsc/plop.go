...
// section 7: PLOP-1 in clause 7.4 and PLOP-2 in clause 7.5, with the acquisition
// sequence of clause 7.2.2 and the idle sequence of clause 7.2.4. Section 8 of that
...
// bit pattern '01010101...' (0x55 octets). CCSDS 231.0-B-4 clause 7.2.2
...
const (
	// PLOP1 is PLOP-1 (clause 7.4): the session ends after each CLTU, so each
	// CLTU is preceded by its own acquisition sequence.
	PLOP1 PLOP = 1

	// PLOP2 is PLOP-2 (clause 7.5): one session carries many CLTUs, separated by
...
const (
	...
	// sequence length (128 bits) per CCSDS 231.0-B-4 clause 7.2.2.
	...
	// not by the standard.
	//
	// Clause 7.2.4 constrains nothing here: the idle sequence is "an
