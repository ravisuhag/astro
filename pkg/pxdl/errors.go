...
var (
	...
	// binary '10', which CCSDS 211.0-B-6 clause 3.2.2.2.2 requires for Version-3.
	...
	// octet range of clause 3.2.2.10.2.
	ErrInvalidFrameLength = errors.New("invalid frame length: must be 5 to 2048 octets")

	// ErrDataTooLarge indicates a data field beyond the 2043 octets clause 3.2.1 allows.
	...
	// Port ID, which CCSDS 211.0-B-6 clause 3.2.2.8.2 forbids.
	...
	// or non-zero on a P-frame where clause 3.2.2.5.2 requires '00'.
	...
	// Clause 3.2.4.1 allows SPDUs only on Expedited.
	...
	// before a first segment for its routing ID (clause 3.2.3.3.5 b).
