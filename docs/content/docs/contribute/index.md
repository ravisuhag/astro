...
The full guide lives in [CONTRIBUTING.md](https://github.com/ravisuhag/astro/blob/main/CONTRIBUTING.md). This page is the short version.
...
cli/                     cobra commands
docs/content/docs/       narrative docs
docs/content/protocols/  one folder per standard
