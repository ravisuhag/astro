...
Every protocol page has the same shape: what Astro implements and what it
leaves to you, a field map from wire fields to Go fields, and the rules that
bite. Each has a [Go API](/protocols/transport/spp) page beside it and a
