...
> **CCSDS 355.0-B-2** · [Blue Book](https://public.ccsds.org/Pubs/355x0b2.pdf) · [`pkg/sdls`](https://github.com/ravisuhag/astro/tree/main/pkg/sdls)
...
- **AES-CMAC** authentication for telecommand (§E2): a 256-bit key, a 32-bit
  ...
  [Telecommand: the §E2 CMAC baseline](/protocols/data-link/sdls#telecommand-the-e2-cmac-baseline).
