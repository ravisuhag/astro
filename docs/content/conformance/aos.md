...
The octets backing this statement live in the [vector corpus](https://github.com/ravisuhag/astro/tree/main/vectors/aos) — 9 vectors. Each vector names the clause it comes from and carries the derivation that produced it.

| File | |
|---|---|
| [`aos/frame.json`](https://github.com/ravisuhag/astro/blob/main/vectors/aos/frame.json) | 7 vectors |
| [`aos/mpdu.json`](https://github.com/ravisuhag/astro/blob/main/vectors/aos/mpdu.json) | 2 vectors |
