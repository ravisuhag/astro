# PICS PROFORMA FOR PACKET UTILIZATION STANDARD
...
| Feature | Reference | Status | Support |
|---|---|---|---|
| Absolute time is PTC 9 | 7.4.4.5a | M | Y |
...
| PFC 19 to 46 — CUC, wider fine time | Table 7-10 | O | P — coarse 1-4 and fine 0-3 only; see A1.5 |
| PFC 1, 2 — CDS format | Table 7-10 | O | N — see A1.5 |
| CCSDS 1958 epoch | 7.4.4.5b note 1 | M | Y |
| Agency-defined epoch | 7.4.4.5b note 1 | O | Y — selects CUC time code Level 2 |
...
|---|---|---|---|
| ST[01] request verification | 8.1 | M | Y — all eight report subtypes |
...
| TC[17,3] / TM[17,4] on-board connection | 8.17.2.3, 8.17.2.4 | O | Y |
...
| Diagnostic parameter reports, TC[3,2] and friends | 8.3.2.2 | N | Structurally identical to housekeeping; a mechanical follow-up. |
| Packet error control field | 7.4.3.2d to f, 7.4.4.2d | N | Checksumming is declared per mission; `pkg/spp` already offers CRC-16 via `WithErrorControl`. |
| User data spare and padding word size | 7.4.3.2b, 7.4.4.2b | N | Padding to the mission word size is left to the caller. |
