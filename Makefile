...
fuzz-smoke:
	...
	go test -run '^$$' -fuzz FuzzDecodeOCM -fuzztime $(FUZZTIME) ./pkg/odm/
	go test -run '^$$' -fuzz FuzzDecodeXMLOPM -fuzztime $(FUZZTIME) ./pkg/odm/
	go test -run '^$$' -fuzz FuzzDecodeXMLOCM -fuzztime $(FUZZTIME) ./pkg/odm/
	...
	go test -run '^$$' -fuzz FuzzDecodeCombined -fuzztime $(FUZZTIME) ./pkg/ndm/
	...
	go test -run '^$$' -fuzz FuzzDecode -fuzztime $(FUZZTIME) ./pkg/csts/
